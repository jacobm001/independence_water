<?php
	class AbzuDB
	{
		...
		public function __construct(&$db)
		{
			...
			$this->qry_guage_to_date_sm = file_get_contents("../api/queries/qet_guage_to_date_sm.sql");
			$this->qry_guage_to_date_lg = file_get_contents("../api/queries/qet_guage_to_date_lg.sql");
